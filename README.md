## The offical code for paper ["Learning to Evaluate Performance of Multi-modal Semantic Localization", TGRS 2022.](https://arxiv.org/abs/2209.06515)
...
### -------------------------------------------------------------------------------------
We recently released SeLo v2, which improves on SeLo and improves the speed and accuracy of SeLo tasks.<a href=https://github.com/xiaoyuan1996/SemanticLocalizationMetrics/blob/master/README_v2.md">
#### Contexts
