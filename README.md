...
### -------------------------------------------------------------------------------------
### We recently released SeLo v2[\[link\]](https://github.com/xiaoyuan1996/SemanticLocalizationMetrics/blob/master/README_v2.md)., which improves SeLo from the speed and accuracy.
